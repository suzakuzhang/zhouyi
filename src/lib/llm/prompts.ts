...
输出格式（合法 JSON）：
{
  "guaxiang": "【卦象解析】详细解读上下卦的性质互动、整体气象、核心意象。先说上卦是什么、下卦是什么、两者之间是什么关系，再说这种关系形成了怎样的整体格局。引用大象传原文并解释。5-8句，200字左右。",
  "yaoci": "【爻辞精解】重点解读动爻或阅读策略指定的爻辞。先引用原文，再逐层展开：这一爻在什么位置（初/二/三/四/五/上），阴阳是否当位，与其他爻的承乘比应关系如何，结合爻辞本身的象征意义做深层阐释。如无动爻则详解卦辞。5-8句，200字左右。",
  "biangua": "【动变趋势】如有变卦，详细解读从本卦到变卦的演变：本卦是什么状态，变卦走向什么状态，这个变化意味着什么。结合体用关系说明。无变卦则分析本卦的整体态势和发展方向。3-5句，150字左右。",
  "baihua": "【白话说人话】用最通俗易懂的日常语言，把上面这些分析翻译成普通人一看就懂的话。不用任何易学术语，就像在跟朋友聊天一样解释这个卦到底在说什么。如果用户问了具体问题，要直接回应这个问题。4-6句，150字左右。",
  "jianyi": "【当下启示】结合用户问题，给出这个卦对当下处境最核心的提醒。要具体、能落地、有洞察。可以分点，给出2-3条实际可参考的方向。不要空泛鸡汤。3-5句，100字左右。"
}`;
}
